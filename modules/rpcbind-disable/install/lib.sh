# Module-specific helpers for rpcbind-disable.
...
# rpcbind + the rpc helper units. Different distros name some
# differently (rpcbind.service vs rpcbind.socket; rpc-statd
# vs nfs-common).
RPC_UNITS=(
    "rpcbind.service"
    "rpcbind.socket"
