# Module-specific helpers for proc-hidepid.
...
PROC_MOUNT_DROPIN="${SELFDEF_PROC_MOUNT_DROPIN:-/etc/systemd/system/proc-hidepid.mount}"
PROC_MARKER="# === selfdef proc-hidepid-managed (do not hand-edit) ==="
