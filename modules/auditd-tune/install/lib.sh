# Module-specific helpers for auditd-tune.
...
AUDITD_CONF="${SELFDEF_AUDITD_CONF:-/etc/audit/auditd.conf}"
AUDITD_BACKUP="${AUDITD_CONF}.selfdef-backup"
AUDITD_MARKER="# === selfdef auditd-tune-managed (do not hand-edit) ==="
