...
| MS013 | partial | 51 SDDs at `implemented` (+ 1 living, 1 review, 4 scoping, 5 draft = 62 total in `docs/sdd/`). Net+24 ratifications since pre-session count. Ongoing as production catches up to spec authoring; SDD-026 + SDD-058 + SDD-059 + SDD-060 are this session's promotions/additions |
