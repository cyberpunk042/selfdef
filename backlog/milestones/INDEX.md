...
| MS013 | partial | 50 SDDs at `implemented` (+ 1 living, 1 review, 4 scoping, 5 draft = 61 total in `docs/sdd/`). Net+23 ratifications since pre-session count. Ongoing as production catches up to spec authoring; SDD-026 + SDD-058 + SDD-059 are this session's promotions/additions |
