...
| MS011 | partial | 9 of 13 Z-vectors shipped end-to-end (Z-4 CPU mode, Z-5 GPU watt, Z-6 composite health, Z-7 network, Z-8 docker-vs-system install paths via `ModuleInstallPaths {scope, paths}` field in `/v1/modules`, Z-9 RAID, Z-10 storage, Z-11 MCP foundation, Z-13 SD-R83). Remaining: Z-1 dashboard-tabs UX, Z-2 LM Studio surface, Z-3 flex-profile state, Z-12 multi-tier REPL, Z-13 SD-R86/SD-R87 |
