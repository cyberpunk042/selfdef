...
**Techniques covered:** 16 (across 6 tactics).
...
| `journald`      | T1078.003 |
| `tetragon`      | T1059.004, T1505.003, T1552.001 |
...
The rule set deliberately stays narrow — it's better to ship 16 high-precision
...
- **Impact** — `wipefs`, `shred`, `rm -rf /`, mass file rewrite. Mostly
  detectable via existing file-system telemetry but no rule shipped yet.
